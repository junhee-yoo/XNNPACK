...
#include "vbinary-microkernel-tester.h"
...
#if XNN_ARCH_WASMSIMD
  TEST(F32_VMAX__WASMSIMD_X8, batch_eq_8) {
    VBinOpMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vmax_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::Max);
  }

  TEST(F32_VMAX__WASMSIMD_X8, batch_div_8) {
    for (size_t batch_size = 16; batch_size < 80; batch_size += 8) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vmax_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::Max);
  ...
  TEST(F32_VMAX__WASMSIMD_X8, batch_lt_8) {
    for (size_t batch_size = 1; batch_size < 8; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vmax_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::Max);
  ...
  TEST(F32_VMAX__WASMSIMD_X8, batch_gt_8) {
    for (size_t batch_size = 9; batch_size < 16; batch_size++) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .Test(xnn_f32_vmax_ukernel__wasmsimd_x8, VBinOpMicrokernelTester::OpType::Max);
  ...
  TEST(F32_VMAX__WASMSIMD_X8, inplace_a) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
  ...
  TEST(F32_VMAX__WASMSIMD_X8, inplace_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .inplace_b(true)
  ...
  TEST(F32_VMAX__WASMSIMD_X8, inplace_a_and_b) {
    for (size_t batch_size = 1; batch_size <= 40; batch_size += 7) {
      VBinOpMicrokernelTester()
        .batch_size(batch_size)
        .inplace_a(true)
