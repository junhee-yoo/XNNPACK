...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VRDIVC_RELU__WASMSIMD_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_relu_ukernel__wasmsimd_x4, VBinOpCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC_RELU__WASMSIMD_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrdivc_relu_ukernel__wasmsimd_x8, VBinOpCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC_RELU__WASM_X1, batch_eq_1) {
    VBinOpCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vrdivc_relu_ukernel__wasm_x1, VBinOpCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC_RELU__WASM_X2, batch_eq_2) {
    VBinOpCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vrdivc_relu_ukernel__wasm_x2, VBinOpCMicrokernelTester::OpType::RDivC);
  }
  ...
  TEST(F32_VRDIVC_RELU__WASM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrdivc_relu_ukernel__wasm_x4, VBinOpCMicrokernelTester::OpType::RDivC);
  }
...
TEST(F32_VRDIVC_RELU__SCALAR_X1, batch_eq_1) {
  VBinOpCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vrdivc_relu_ukernel__scalar_x1, VBinOpCMicrokernelTester::OpType::RDivC, VBinOpCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VRDIVC_RELU__SCALAR_X2, batch_eq_2) {
  VBinOpCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vrdivc_relu_ukernel__scalar_x2, VBinOpCMicrokernelTester::OpType::RDivC, VBinOpCMicrokernelTester::Variant::Scalar);
}
