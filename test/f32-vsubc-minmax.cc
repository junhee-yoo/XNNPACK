...
#include "vbinaryc-microkernel-tester.h"
  ...
  TEST(F32_VSUBC_MINMAX__NEON_X4, batch_eq_4) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_minmax_ukernel__neon_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__NEON_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_minmax_ukernel__neon_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__SSE_X4, batch_eq_4) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_minmax_ukernel__sse_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__SSE_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_minmax_ukernel__sse_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__AVX_X8, batch_eq_8) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_minmax_ukernel__avx_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__AVX_X16, batch_eq_16) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsubc_minmax_ukernel__avx_x16, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__AVX512F_X16, batch_eq_16) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsubc_minmax_ukernel__avx512f_x16, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__AVX512F_X32, batch_eq_32) {
    ...
    VBinOpCMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vsubc_minmax_ukernel__avx512f_x32, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASMSIMD_ARM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasmsimd_arm_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASMSIMD_ARM_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasmsimd_arm_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASMSIMD_X86_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasmsimd_x86_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASMSIMD_X86_X8, batch_eq_8) {
    VBinOpCMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasmsimd_x86_x8, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASM_X1, batch_eq_1) {
    VBinOpCMicrokernelTester()
      .batch_size(1)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasm_x1, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASM_X2, batch_eq_2) {
    VBinOpCMicrokernelTester()
      .batch_size(2)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasm_x2, VBinOpCMicrokernelTester::OpType::SubC);
  }
  ...
  TEST(F32_VSUBC_MINMAX__WASM_X4, batch_eq_4) {
    VBinOpCMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vsubc_minmax_ukernel__wasm_x4, VBinOpCMicrokernelTester::OpType::SubC);
  }
...
TEST(F32_VSUBC_MINMAX__SCALAR_X1, batch_eq_1) {
  VBinOpCMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vsubc_minmax_ukernel__scalar_x1, VBinOpCMicrokernelTester::OpType::SubC, VBinOpCMicrokernelTester::Variant::Scalar);
}
...
TEST(F32_VSUBC_MINMAX__SCALAR_X2, batch_eq_2) {
  VBinOpCMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vsubc_minmax_ukernel__scalar_x2, VBinOpCMicrokernelTester::OpType::SubC, VBinOpCMicrokernelTester::Variant::Scalar);
}
